    ...
    <div className="flex min-h-screen flex-col bg-canvas">
      ...
      <main className="mx-auto w-full max-w-3xl flex-1 px-6 py-10 sm:py-14">
        ...
        <div className="mt-8 flex flex-col gap-6 text-xs leading-relaxed text-ink-muted">
          ...
          <section>
            <h2 className="font-mono text-xs font-bold uppercase tracking-wider text-ink">Market data</h2>
            <p className="mt-2">
          ...
          <section>
            <h2 className="font-mono text-xs font-bold uppercase tracking-wider text-ink">AI Insights chat</h2>
            <p className="mt-2">
          ...
          <section>
            <h2 className="font-mono text-xs font-bold uppercase tracking-wider text-ink">Local preferences</h2>
            <p className="mt-2">
          ...
          <p>
            Questions about this policy can be sent via the <Link href="/contact" className="text-brand hover:underline font-mono text-[10px] uppercase font-bold tracking-wider">contact page</Link>.
          </p>
        </div>
      </main>
